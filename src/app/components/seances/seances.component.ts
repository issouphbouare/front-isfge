...
export class SeancesComponent {
  ...
  constructor(private http: HttpClient,private anneeService: AnneeService,
    private tokenStorageService: TokenStorageService, private apiService: SeanceService
    ,
  ...
  onSearch() {
    this.apiService.search(this.annee, this.personnel, this.keyword, this.currentPage, this.size, this.sort, this.direction)
  ...
  getNBHeures(){
    ...
    this.donnees.forEach((e :any) => {
      this.nombreHeure+=e.nombreHeure
    });
  }
  }
